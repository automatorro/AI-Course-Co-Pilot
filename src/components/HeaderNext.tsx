                 ...
                 <div className="relative" ref={dropdownRef}>
                    ...
                    {isDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-56 card-premium py-1 z-50">
                            ...
                            <div className="py-1">
                                <Link href="/profile" onClick={() => setIsDropdownOpen(false)} className="w-full text-left px-4 py-2 text-sm text-ink-700 dark:text-ink-200 hover:bg-ink-50 dark:hover:bg-ink-800 flex items-center gap-3">
                                  <UserIcon size={16} />
                                  {t('header.profile')}
                                </Link>
                                <Link href="/dashboard" onClick={() => setIsDropdownOpen(false)} className="w-full text-left px-4 py-2 text-sm text-ink-700 dark:text-ink-200 hover:bg-ink-50 dark:hover:bg-ink-800 flex items-center gap-3">
                                  <LayoutDashboard size={16} />
                                  {t('header.dashboard')}
                                </Link>
                                <Link href="/billing" onClick={() => setIsDropdownOpen(false)} className="w-full text-left px-4 py-2 text-sm text-ink-700 dark:text-ink-200 hover:bg-ink-50 dark:hover:bg-ink-800 flex items-center gap-3">
                                  <CreditCard size={16} />
                                  {t('header.billing')}
                                </Link>
                                <button onClick={handleLogout} className="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-ink-50 dark:hover:bg-ink-800 flex items-center gap-3">
                                  <LogOut size={16} />
                                  {t('header.logout')}
                                </button>
                            </div>
