      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="text-sm text-ink-700 hover:text-primary-600 dark:text-ink-200 dark:hover:text-primary-400 transition-colors">
              {t('footer.home')}
            </Link>
            <Link href="/#pricing" className="text-sm text-ink-700 hover:text-primary-600 dark:text-ink-200 dark:hover:text-primary-400 transition-colors">
              {t('footer.pricing')}
            </Link>
          </div>
        </div>
